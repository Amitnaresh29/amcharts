...
for (var i = 1; i < 500; i++) {
  ...
  data.push({ date: new Date(2018, 0, i, 0,0,0,0), value: 0 });
}

chart.data = data;

var popup = chart.openPopup("<div>1.Click on plot area to add points<br>2.Drag bullets to change values<br>3.Double click on bullet to remove</div>");
popup.top = 60;
popup.right = 30;
